    ...
    <section class="shop-products-section">
        ...
        <div class="products-filter">
            ...
            <aside class="filter">
                <!-- Filter -->
                <h2>Filter</h2>
                <form action="{{ route('products.index', ['category' => $categoryName]) }}" method="GET">
                    <div class="filter-options">
                        ...
                        <div class="filter-option">
                            <h3>Výrobca</h3>
                            <ul>
                                <li><input type="checkbox" name="maker[]" value="allforbees"> AllForBees</li>
                                <li><input type="checkbox" name="maker[]" value="vcelari"> Včelári.sk</li>
                                <li><input type="checkbox" name="maker[]" value="vcielka"> Včielka</li>
                                <li><input type="checkbox" name="maker[]" value="beeplus"> BeePlus</li>
                            </ul>
                        </div>
